class V2::RollsController < ApplicationController
    ...
    def create
        begin            
            @roll = current_user.rolls.create!(caption: params[:caption], restricted: current_user.restricted || false, private: params[:private] || true) 
            ...
            if @roll.save
                ...
                CreateLocationJob.perform_later(params[:ip_address] || request.ip, params[:timezone], @roll.id, @roll.class.name)
