class PostsController < ApplicationController
  ...
  def show
    ...
    if @post
      ...
      render json: {id: @post.id ,user_id: @post.user_id, view_count: @post.view_count, caption: @post.caption, created_at: @post.created_at, image_url: url_for(post_image), user_tags}, status: :ok
    else
