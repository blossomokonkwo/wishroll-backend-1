class Api::V2::RollsController < APIController
    before_action :authorize_by_access_header!
    def create
        begin            
            @roll = current_user.rolls.create!(caption: params[:caption], restricted: current_user.restricted, private: params[:private] || false, width: params[:width], height: params[:height], duration: params[:duration]) 
