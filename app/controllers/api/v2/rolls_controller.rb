class Api::V2::RollsController < APIController
    ...
    def create
        begin            
            @roll = current_user.rolls.create!(caption: params[:caption], restricted: current_user.restricted, width: params[:width], height: params[:height], duration: params[:duration]) 
