class Tag < ApplicationRecord
    ...
    pg_search_scope :new_search, against: {text: 'A'}, using: {tsearch: {dictionary: :english, tsvector_column: :tsv_text, any_word: true}}, order_within_rank: "tags.created_at DESC"
