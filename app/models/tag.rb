class Tag < ApplicationRecord
    ...
    #search API's 
    pg_search_scope :search, against: :text, using: {tsearch: {prefix: false, dictionary: "english", normalization: 0, any_word: false, tsvector_column: "tsv_text"}}, order_within_rank: "tags.created_at DESC"
