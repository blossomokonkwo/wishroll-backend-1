class Tag < ApplicationRecord
    ...
    #search API's 
    pg_search_scope :search, against: :text, using: {tsearch: {any_word: true, normalization: 4, dictionary: :english, tsvector_column: :tsv_text}}, order_within_rank: "tags.created_at DESC"
