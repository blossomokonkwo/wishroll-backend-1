class Tag < ApplicationRecord
    ...
    pg_search_scope :new_search, against: :text, using: {tsearch: {dictionary: :english, tsvector_column: :tsv_text, normalization: 16}}, order_within_rank: "tags.created_at DESC"
