class Tag < ApplicationRecord
    ...
    #search API's 
    pg_search_scope :search, against: {text: 'A'}, using: {tsearch: {dictionary: :english, tsvector_column: :tsv_text, any_word: true, prefix: true}}, order_within_rank: "tags.created_at DESC"
