class Tag < ApplicationRecord
    ...
    pg_search_scope :new_search, against: :text, using: {tsearch: {tsvector_column: :tsv_text, any_word: true, normalization: 16, dictionary: :english}}, order_within_rank: "tags.created_at DESC"
