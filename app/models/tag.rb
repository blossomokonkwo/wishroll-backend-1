class Tag < ApplicationRecord
    ...
    pg_search_scope :trending_tag, against: :text, using: {tsearch: {dictionary: :english, prefix: true, tsvector_column: :tsv_text, any_word: true}}, order_within_rank: "tags.created_at ASC"
