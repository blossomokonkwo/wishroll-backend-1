            ...
            if user.current_device
                ...
                if activity.activity_type == "Comment"
                    ...
                    if post = comment.post
                        activity_hash = {id: activity.id, phrase: activity.activity_phrase, created_at: activity.created_at, type: activity.activity_type, active_user: {id: activity.active_user.id, username: activity.active_user.username, name: activity.active_user.name, avatar: activity.active_user.avatar_url, verified: activity.active_user.verified}, comment: {id: comment.id, original_comment_id: comment.original_comment_id, created_at: comment.created_at, updated_at: comment.updated_at, like_count: comment.likes_count, body: comment.body, reply_count: comment.replies_count, user: {id: comment.user.id, username: comment.user.username, name: comment.user.name, verified: comment.user.verified, avatar: comment.user.avatar_url}}, post: {id: post.id, uuid: post.uuid, media_url: post.media_url, thumbnail_url: post.thumbnail_url, like_count: post.likes_count, caption: post.caption, view_count: post.view_count, created_at: post.created_at, updated_at: post.updated_at, comment_count: post.comments_count, share_count: post.share_count, viewed: true, liked: false, bookmarked: false, bookmark_count: post.bookmark_count, user: {id: post.user.id, username: post.user.username, name: post.user.name, avatar: post.user.name, verified: post.user.verified}}}
                    ...
                    activity_hash = {id: activity.id, phrase: activity.activity_phrase, created_at: activity.created_at, type: activity.activity_type, active_user: {id: activity.active_user.id, username: activity.active_user.username, name: activity.active_user.name, avatar: activity.active_user.avatar_url, verified: activity.active_user.verified}, post: {id: post.id, uuid: post.uuid, media_url: post.media_url, thumbnail_url: post.thumbnail_url, like_count: post.likes_count, caption: post.caption, view_count: post.view_count, created_at: post.created_at, updated_at: post.updated_at, comment_count: post.comments_count, share_count: post.share_count, viewed: true, liked: false, bookmarked: false, bookmark_count: post.bookmark_count, user: {id: post.user.id, username: post.user.username, name: post.user.name, verified: post.user.verified}}}
